...
#define INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_BEGIN(LABEL,RET,FUNCNAME) \
		_STRACE("[REGISTER] %s ClassFunc::%s\n", #RET, #FUNCNAME); \
		PMon::Register(LABEL "::" #FUNCNAME, PMon::PMON_CALC); \
		class luafuncClass##FUNCNAME{ \
		public: \
			static int func(lua_State* L) { \
				_STRACE("Called LuaFunc %s LUAFUNC_%s\n", #RET, #FUNCNAME); \
				PMon::Start(LABEL "::" #FUNCNAME); \
				/* ICLASS* thisptr = *(ICLASS**)lua_touserdata(L,1);*/ \
				ICLASS* thisptr = **static_cast<LuaRefPtr<ICLASS>**>(lua_touserdata(L, 1));
...
#define LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_ARG0(LABEL,RET,FUNCNAME) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_BEGIN(LABEL,RET,FUNCNAME) \
		int code = LUAPUSH<RET>(L,thisptr->FUNCNAME()); \
    PMon::Stop(LABEL "::" #FUNCNAME); \
    return code; \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_END(RET,FUNCNAME)

#define LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_ARG1(LABEL,RET,FUNCNAME,ARG1) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		int code = LUAPUSH<RET>(L,thisptr->FUNCNAME(arg1)); \
    PMon::Stop(LABEL "::" #FUNCNAME); \
    return code; \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_END(RET,FUNCNAME)

#define LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_ARG2(LABEL,RET,FUNCNAME,ARG1,ARG2) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		int code = LUAPUSH<RET>(L,thisptr->FUNCNAME(arg1,arg2)); \
    PMon::Stop(LABEL "::" #FUNCNAME); \
    return code; \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_END(RET,FUNCNAME)

#define LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_ARG3(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
		int code = LUAPUSH<RET>(L,thisptr->FUNCNAME(arg1,arg2,arg3)); \
    PMon::Stop(LABEL "::" #FUNCNAME); \
    return code; \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_END(RET,FUNCNAME)

#define LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_ARG4(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3,ARG4) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
		ARG4 arg4 = LUACAST<ARG4>(L, 5); \
		int code = LUAPUSH<RET>(L,thisptr->FUNCNAME(arg1,arg2,arg3,arg4)); \
    PMon::Stop(LABEL "::" #FUNCNAME); \
    return code; \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_END(RET,FUNCNAME)

#define LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_ARG5(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3,ARG4,ARG5) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
		ARG4 arg4 = LUACAST<ARG4>(L, 5); \
		ARG5 arg5 = LUACAST<ARG5>(L, 6); \
		int code = LUAPUSH<RET>(L,thisptr->FUNCNAME(arg1,arg2,arg3,arg4,arg5)); \
    PMon::Stop(LABEL "::" #FUNCNAME); \
    return code; \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_END(RET,FUNCNAME)

#define LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_ARG6(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3,ARG4,ARG5,ARG6) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
		...
		ARG5 arg5 = LUACAST<ARG5>(L, 6); \
		ARG6 arg6 = LUACAST<ARG6>(L, 7); \
		int code = LUAPUSH<RET>(L,thisptr->FUNCNAME(arg1,arg2,arg3,arg4,arg5,arg6)); \
    PMon::Stop(LABEL "::" #FUNCNAME); \
    return code; \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_END(RET,FUNCNAME)

#define LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_ARG7(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3,ARG4,ARG5,ARG6,ARG7) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
		...
		ARG6 arg6 = LUACAST<ARG6>(L, 7); \
		ARG7 arg7 = LUACAST<ARG7>(L, 8); \
		int code = LUAPUSH<RET>(L,thisptr->FUNCNAME(arg1,arg2,arg3,arg4,arg5,arg6,arg7)); \
    PMon::Stop(LABEL "::" #FUNCNAME); \
    return code; \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_END(RET,FUNCNAME)

#define LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_ARG8(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3,ARG4,ARG5,ARG6,ARG7,ARG8) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
		...
		ARG6 arg6 = LUACAST<ARG6>(L, 7); \
		ARG7 arg7 = LUACAST<ARG7>(L, 8); \
		ARG8 arg8 = LUACAST<ARG8>(L, 9); \
		int code = LUAPUSH<RET>(L,thisptr->FUNCNAME(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8)); \
    PMon::Stop(LABEL "::" #FUNCNAME); \
    return code; \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_END(RET,FUNCNAME)

#define LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_ARG9(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3,ARG4,ARG5,ARG6,ARG7,ARG8,ARG9) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
		...
		ARG7 arg7 = LUACAST<ARG7>(L, 8); \
		ARG8 arg8 = LUACAST<ARG8>(L, 9); \
		ARG9 arg9 = LUACAST<ARG9>(L, 10); \
		int code = LUAPUSH<RET>(L,thisptr->FUNCNAME(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9)); \
    PMon::Stop(LABEL "::" #FUNCNAME); \
    return code; \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_END(RET,FUNCNAME)

#define LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_ARG10(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3,ARG4,ARG5,ARG6,ARG7,ARG8,ARG9,ARG10) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_CALC_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
		...
		ARG8 arg8 = LUACAST<ARG8>(L, 9); \
		ARG9 arg9 = LUACAST<ARG9>(L, 10); \
		ARG10 arg10 = LUACAST<ARG10>(L, 11); \
		int code = LUAPUSH<RET>(L,thisptr->FUNCNAME(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10)); \
    PMon::Stop(LABEL "::" #FUNCNAME); \
    return code; \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_END(RET,FUNCNAME)

#define LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_ARG0(LABEL,RET,FUNCNAME) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_BEGIN(LABEL,RET,FUNCNAME) \
		int code = LUAPUSH<RET>(L,thisptr->FUNCNAME()); \
    PMon::Stop(LABEL "::" #FUNCNAME); \
    return code; \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_END(RET,FUNCNAME)

#define LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_ARG1(LABEL,RET,FUNCNAME,ARG1) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		int code = LUAPUSH<RET>(L,thisptr->FUNCNAME(arg1)); \
    PMon::Stop(LABEL "::" #FUNCNAME); \
...
#define LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_ARG2(LABEL,RET,FUNCNAME,ARG1,ARG2) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		int code = LUAPUSH<RET>(L,thisptr->FUNCNAME(arg1,arg2)); \
...
#define LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_ARG3(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
...
#define LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_ARG4(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3,ARG4) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
...
#define LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_ARG5(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3,ARG4,ARG5) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
...
#define LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_ARG6(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3,ARG4,ARG5,ARG6) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
...
#define LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_ARG7(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3,ARG4,ARG5,ARG6,ARG7) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
...
#define LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_ARG8(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3,ARG4,ARG5,ARG6,ARG7,ARG8) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
...
#define LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_ARG9(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3,ARG4,ARG5,ARG6,ARG7,ARG8,ARG9) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
...
#define LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_ARG10(LABEL,RET,FUNCNAME,ARG1,ARG2,ARG3,ARG4,ARG5,ARG6,ARG7,ARG8,ARG9,ARG10) \
	INTERNAL_LUA_SCRIPTCLASS_METHOD_MEASURE_COMM_BEGIN(LABEL,RET,FUNCNAME) \
		ARG1 arg1 = LUACAST<ARG1>(L, 2); \
		ARG2 arg2 = LUACAST<ARG2>(L, 3); \
		ARG3 arg3 = LUACAST<ARG3>(L, 4); \
