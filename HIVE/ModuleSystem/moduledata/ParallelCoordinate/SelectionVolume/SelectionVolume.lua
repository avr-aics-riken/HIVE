SelectionVolume = {}
setmetatable(SelectionVolume, {__index = HiveBaseModule})

SelectionVolume.new = function (varname)
    local this = HiveBaseModule.new(varname)
    local pm = PolygonModel();
    this.pmodel = pm
    
    setmetatable(this, {__index=SelectionVolume})
    return this
end

function SelectionVolume:Do()    
...
function SelectionVolume:model()
    return self.pmodel;
end
