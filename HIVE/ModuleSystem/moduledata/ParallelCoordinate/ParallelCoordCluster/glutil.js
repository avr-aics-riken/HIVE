...
function create_framebuffer(gl, ext, width, height){
    ...
    var ftType = ext != null ? gl.FLOAT : gl.UNSIGNED_BYTE;
    gl.bindTexture(gl.TEXTURE_2D, fTexture);
    gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, width, height, 0, gl.RGBA, ftType, null);
