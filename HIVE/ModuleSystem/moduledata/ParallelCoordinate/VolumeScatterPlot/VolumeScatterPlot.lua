VolumeScatterPlot = {}
setmetatable(VolumeScatterPlot, {__index = HiveBaseModule})

VolumeScatterPlot.new = function (varname)
    local this = HiveBaseModule.new(varname)
    local pm = PolygonModel();
    this.pmodel = pm
    
    setmetatable(this, {__index=VolumeScatterPlot})
    return this
end

function VolumeScatterPlot:Do()    
...
function VolumeScatterPlot:model()
    return self.pmodel;
end
